<template>
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    ...
    <div v-if="dataLoaded" >
        ...
        <div v-if="data.workoutType == 'strength'" class="flex flex-col gap-y-4 w-full">
          <div class="flex flex-col gap-x-6 gap-y-2 relative sm:flex-row" v-for="(item,index) in data.exercises" :key="index">
            ...
            <div class="flex flex-2 flex-col md:w-1/3">
              ...
              <input v-if="edit" type="text" id="exercise-name" class="p-2 w-full text-gray-500 focus:outline-none" required v-model="item.exercise">
            ...
            <div class="flex flex-1 flex-col">
              ...
              <input id="sets" v-if="edit" type="text" class="p-2 w-full text-gray-500 focus:outline-none" required v-model="item.sets">
            ...
            <div class="flex flex-1 flex-col">
              ...
              <input id="reps" v-if="edit" type="text" class="p-2 w-full text-gray-500 focus:outline-none" required v-model="item.reps">
            ...
            <div class="flex flex-1 flex-col">
              ...
              <input id="weight" v-if="edit" type="text" class="p-2 w-full text-gray-500 focus:outline-none" required v-model="item.weight">
          ...
          <button v-if="edit" @click="addExercise" type="button"  class="mt-6 py-2 px-6 rounded self-start text-sm text-white bg-at-light-green duration-200 border-solid border-2 border-transparent hover:border-at-light-green hover:bg-white hover:text-at-light-green">
            Add Exercise
          </button>
        </div>
        ...
        <div v-else class="flex flex-col gap-y-4 w-full">
          <div class="flex flex-col gap-x-6 gap-y-2 relative sm:flex-row" v-for="(item,index) in data.exercises" :key="index">
            ...
            <div class="flex flex-2 flex-col md:w-1/3">
              ...
              <select v-if="edit" type="text" id="cardioType" class="p-2 w-full text-gray-500 focus:outline-none" required v-model="item.cardioType">
            ...
            <div class="flex flex-1 flex-col">
              ...
              <input id="distance" v-if="edit" type="text" class="p-2 w-full text-gray-500 focus:outline-none" required v-model="item.distance">
            ...
            <div class="flex flex-1 flex-col">
              ...
              <input id="duration" v-if="edit" type="text" class="p-2 w-full text-gray-500 focus:outline-none" required v-model="item.duration">
            ...
            <div class="flex flex-1 flex-col">
              ...
              <input id="weight" v-if="edit" type="text" class="p-2 w-full text-gray-500 focus:outline-none" required v-model="item.pace">
          ...
          <button @click="addExercise" v-if="edit" type="button"  class="mt-6 py-2 px-6 rounded self-start text-sm text-white bg-at-light-green duration-200 border-solid border-2 border-transparent hover:border-at-light-green hover:bg-white hover:text-at-light-green">
            Add Exercise
          </button>
        </div>
      ...
      <!-- Update -->
      <button @click="update" type="button" v-if="edit"  class="mt-10 py-2 px-6 rounded self-start text-sm text-white bg-at-light-green duration-200 border-solid border-2 border-transparent hover:border-at-light-green hover:bg-white hover:text-at-light-green">
        Update Workout
      </button>
